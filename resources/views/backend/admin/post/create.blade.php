...
@section('title', __('Thêm bài viết'))

@section('content')
    <div class="row row-deck">
        <div class="col-12">
            <form class="form card" action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('tags') }}" type="text" id="tags" name="tags" placeholder="Enter tags"
                                    class="form-control">
                            </div>
                            <div class="mb-3">
