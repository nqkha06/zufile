                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="white-space: nowrap">
                                <a href="{{ sortable_url('admin.popular.stu', 'alias') }}" class="table-sort {{ request('sort_by') == 'alias' ? request('sort_order') : '' }}" data-sort="sort-name">{{ __('links.link') }}</a>
                            </th>
                            <th style="white-space: nowrap">
                                <a href="{{ sortable_url('admin.popular.stu', 'created_at') }}" class="table-sort {{ request('sort_by') == 'created_at' ? request('sort_order') : '' }}" data-sort="sort-name">{{ __('links.date_created') }}</a>
                            </th>
                            ...
                            @foreach ($links as $key => $link)
                                <tr>
                                    ...
                                    <td style="white-space: nowrap"><a
                                            href="{{ ($_settings['stu_url'] ?? env('APP_URL')) . '/' . $link->alias }}"
                                            target="__blank">{{ ($_settings['stu_url'] ?? env('APP_URL')) . '/' . $link->alias }}</a>
                                    </td>
                                    <td style="white-space: nowrap">
