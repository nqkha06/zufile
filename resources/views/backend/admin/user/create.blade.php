                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6" id="password_field">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div id="payment-details">
                                {{-- @php
                                $oldPaymentMethods = $paymentMethods->first(int(old('payment_method')));
                                $dataOldPmt = old('fields');
                                @endphp
                                
                                @if (old('payment_method') && $oldPaymentMethods)
                                    @php
                                        dd($dataOldPmt);

                                        $fields = json_decode($oldPaymentMethods->fields, true);
                                    @endphp
                            ...
                            @foreach ($roles as $role)
                                <label class="form-check form-check-inline">
                                    <input class="form-check-input" name="roles[]" type="checkbox"
                                        value="{{ $role }}" @checked( $role == old('role'))>
