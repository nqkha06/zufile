...
@endsection
@section('content')
<p>Xem thông tin người dùng: <a href="{{ route('admin.invoices.index').'?user='.$user->id }}">Hoá đơn</a> - <a href="{{ route('admin.stu.index').'?user='.$user->id }}">Links: STU</a> - <a href="{{ route('admin.note.index').'?user='.$user->id }}">Links: NOTE</a> - <a href="{{ route('admin.invoices.create').'?user='.$user->id }}">Rút tiền</a></p>
<div class="row g-5">
