...
@section('nav')
    <nav id="file-tool">
        <ul id="tools" role="list">
            <li data-bs-toggle="tooltip" title="{{ __('member/files/index.tools.move') }}" data-bs-placement="bottom" data-bs-trigger="hover">
            ...
            <li data-bs-toggle="tooltip" title="{{ __('member/files/index.tools.rename') }}" data-bs-placement="bottom" data-bs-trigger="hover">
            ...
            <li data-bs-toggle="tooltip" title="{{ __('member/files/index.tools.delete') }}" data-bs-placement="bottom" data-bs-trigger="hover">
            ...
            <li data-bs-toggle="tooltip" title="{{ __('member/files/index.tools.share') }}" data-bs-placement="bottom" data-bs-trigger="hover">
            ...
            <li data-bs-toggle="tooltip" title="{{ __('member/files/index.tools.download') }}" data-bs-placement="bottom" data-bs-trigger="hover">
        ...
        <ul role="list">
            <li data-bs-toggle="tooltip" title="{{ __('member/files/index.tools.create_folder') }}" data-bs-placement="bottom" data-bs-trigger="hover">
            ...
            <li data-bs-toggle="tooltip" title="{{ __('member/files/index.tools.layout') }}" data-bs-placement="bottom" data-bs-trigger="hover">
    ...
    <div id="upload-alert" class="bg-yellow-50 p-4 hidden">
        <div class="flex items-center leading-[normal]">
            ...
            <div class="ml-3">
                <span class="text-sm font-medium text-yellow-800">{{ __('member/files/index.upload_alert') }}</span>
            </div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <div id="filemanager" class="hidden">
        ...
        <div id="empty" class="hidden space-y-4 text-center mx-auto p-4 sm:p-6 lg:p-8">
            ...
            <p class="tm">{{ __('member/files/index.empty_message') }}</p>
            <label for="file" class="button !w-fit mx-auto">
                ...
                <span>{{ __('member/files/index.start_uploading') }}</span>
            </label>
        </div>
    </div>
...
@push('scripts')
    {{-- @vite(['resources/js/pages/drive.js']) --}}
