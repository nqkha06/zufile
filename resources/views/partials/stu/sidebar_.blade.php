    ...
    <div class="section" id="side-widget">
                        ...
                        <div class="iCtnt">
                            <div class="iInr">
                                <h3 class="iTtl aTtl"><a
                                        href="{{ route('blog.show', $val->slug) }}">{{ $val->title }}</a>
                                </h3>
                                @if ($flag)
        ...
        <div class="widget Label" id="Label00">
            ...
            <div class="wL pSml bg cl">
                ...
                @endif
                <div class="lbSz">
                    <a aria-label="Disqus" class="lbN"
                        href="{{ route('blog.categories', $val->slug) }}">
                        <span class="lbT">{{ $val->name }}</span>
                        <span class="lbC" data-text="({{ $cnt }})"></span>
                    </a>
                </div>
                @endforeach
            </div>
