/*<![CDATA[*/
/**
 * Anti Ad Blocker Code by QKTeam
 * Last Updated: 16:42 12/08/2023 IST
 * Copyright: [qkha.dev QKTeam](https://www.quockhablog.com)
 */
...
function antiAdBlockerHandler() {
    window.checkAdsStatus(function (ads) {
        if (!ads.allowed) {
            ...
            const title = "Phát hiện sử dụng AdBlocker :(";
            const message = "<p>Chúng tôi hiểu rằng quảng cáo có thể gây phiền nhiễu. Tuy nhiên, chúng là nguồn thu nhập chính giúp chúng tôi vận hành trang web này.<br/>Để tiếp tục, vui lòng tắt trình chặn quảng cáo hoặc thêm trang web của chúng tôi vào danh sách trắng trong tiện ích chặn quảng cáo của bạn.</p>";
